...
Public Class FrmBulkMigration
    ...
    Private Sub FrmBulkMigration_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        With cbxBankPD
            .ValueMember = "ID"
            .DisplayMember = "Bank"
            DT_BankPD = DataSource("SELECT ID, Short_Name AS 'Bank' FROM bank_setup WHERE `status` = 'ACTIVE' ORDER BY Short_Name;")
            .DataSource = DT_BankPD.Copy
            .SelectedIndex = -1
        End With
    ...
    Private Sub FixUI(ApplyUI As Boolean)
        Try
            ...
            GetComboBoxFontSettings({cbxBusinessCenter, cbxProduct, cbxBank, cbxBankPD})
    ...
    Private Sub LoadData()
        ...
        SQL &= "    '' AS 'Due Date',"
        SQL &= "    '' AS 'Principal',"
        SQL &= "    '' AS 'Principal Balance',"
        SQL &= "    '' AS 'UDI',"
        SQL &= "    '' AS 'UDI Balance',"
        SQL &= "    '' AS 'RPPD',"
        SQL &= "    '' AS 'RPPD Balance',"
        SQL &= "    '' AS 'Unpaid Penalty',"
        SQL &= "    '' AS 'GMA',"
        SQL &= "    '' AS 'Monthly Rebate',"
        SQL &= "    '' AS 'BankID',"
        SQL &= "    '' AS 'Bank',"
        SQL &= "    '' AS 'CV Number',"
        SQL &= "    '' AS 'DT_BankPD_ID',"
        SQL &= "    '' AS 'PDL/SML Bank',"
        SQL &= "    '' AS 'PDL/SML Account',"
        SQL &= "    '' AS 'PDL/SML Card',"
        SQL &= "    '' AS 'PDL/SML ATM',"
        SQL &= "    '' AS 'Remarks', 0 AS 'MortgageID'"
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If MsgBoxYes(mSave) = MsgBoxResult.Yes Then
            ...
            For x As Integer = 0 To GridView1.RowCount - 1
                ...
                SQL &= String.Format(" BusinessID = '{0}', ", GridView1.GetRowCellValue(x, "BusinessID"))
                SQL &= String.Format(" branch_code = '{0}', ", Branch_Code)
                SQL &= " Interest_N = 0, "
                SQL &= " RPPD_N = 0, "
                SQL &= " Principal_N = 0, "
                SQL &= String.Format(" BankID = '{0}', ", GridView1.GetRowCellValue(x, "BankID"))
                SQL &= String.Format(" PD_ATM = '{0}', ", If(GridView1.GetRowCellValue(x, "PDL/SML ATM").ToString = "1", 1, 0))
                SQL &= String.Format(" PD_CardNumber = '{0}', ", GridView1.GetRowCellValue(x, "PDL/SML Card"))
                SQL &= String.Format(" PD_AccountNumber = '{0}', ", GridView1.GetRowCellValue(x, "PDL/SML Account"))
                SQL &= String.Format(" Remarks = '{0}', ", GridView1.GetRowCellValue(x, "Remarks"))
                SQL &= String.Format(" PD_BankID = '{0}', ", If(GridView1.GetRowCellValue(x, "DT_BankPD_ID").ToString = "", 0, GridView1.GetRowCellValue(x, "DT_BankPD_ID")))
    ...
    Private Sub BtnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        If MsgBoxYes("Are you sure you want to export this to Excel Format?") = MsgBoxResult.Yes Then
            ...
            With Report
                ...
                .lblIndustry.DataBindings.Add("Text", DT, "PDL/SML Account")
                .ExportToXlsx(FName)
                Process.Start(FName)
            End With
            Cursor = Cursors.Default
                ...
                Using con As New OleDb.OleDbConnection()
                    Try
                        ...
                        For x As Integer = 0 To DT_Excel.Rows.Count - 1
                            ...
                            Else
                                Temp_DT.Rows.Add(x + 1, DT_Excel(x)("BorrowerID").ToString.Trim, DataObject(String.Format("SELECT Borrower('{0}');", DT_Excel(x)("BorrowerID").ToString.Trim)), 0, DT_Excel(x)("Business Center"), 0, DT_Excel(x)("Product"), DT_Excel(x)("Account Number"), DT_Excel(x)("Collateral"), DT_Excel(x)("Terms"), DT_Excel(x)("Interest %"), DT_Excel(x)("RPPD %"), CDate(DT_Excel(x)("Date Availed")), CDate(DT_Excel(x)("FDD")), CDate(If(DT_Excel(x)("Last Payment").ToString = "", DT_Excel(x)("Date Availed"), DT_Excel(x)("Last Payment"))), DT_Excel(x)("Due Date"), DT_Excel(x)("Principal"), DT_Excel(x)("Principal Balance"), DT_Excel(x)("UDI"), DT_Excel(x)("UDI Balance"), DT_Excel(x)("RPPD"), DT_Excel(x)("RPPD Balance"), If(DT_Excel(x)("Unpaid Penalty").ToString = "", 0, DT_Excel(x)("Unpaid Penalty")), DT_Excel(x)("GMA"), DT_Excel(x)("Monthly Rebate"), 0, DT_Excel(x)("Bank"), DT_Excel(x)("CV Number"), 0, DT_Excel(x)("PDL/SML Bank"), DT_Excel(x)("PDL/SML Account"), DT_Excel(x)("PDL/SML Card"), DT_Excel(x)("PDL/SML ATM"), DT_Excel(x)("Remarks"), 0)
                            End If
                        Next
                        GridControl1.DataSource = Temp_DT.Copy
                        MigrationMode = True
                        With GridView1
                            For x As Integer = 0 To .RowCount - 1
                                ...
                                .SetRowCellValue(x, "PDL/SML Bank", .GetRowCellValue(x, "PDL/SML Bank"))
                                cbxBankPD.Text = .GetRowCellDisplayText(x, "PDL/SML Bank")
                                .SetRowCellValue(x, "DT_BankPD_ID", cbxBankPD.SelectedValue)
                            Next
                        End With
                        MigrationMode = False
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        ElseIf e.Column.FieldName = "PDL/SML Bank" Then
            cbxBankPD.Text = GridView1.GetRowCellDisplayText(GridView1.FocusedRowHandle, "PDL/SML Bank")
            cbxBankPD_SelectedIndexChanged(sender, e)
        End If
    End Sub
    ...
    Private Sub CbxBankPD_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxBankPD.SelectedIndexChanged
        If FirstLoad Or MigrationMode Then
            Exit Sub
        End If

        GridView1.SetRowCellValue(GridView1.FocusedRowHandle, "DT_BankPD_ID", cbxBankPD.SelectedValue)
    End Sub
    ...
    Private Sub BtnExportNotes_Click(sender As Object, e As EventArgs) Handles btnExportNotes.Click
        ...
        With Report
            ...
            With PD_Bank
                .DataSource = DT_BankPD
                Report.subRptBank_PD.ReportSource = PD_Bank
                .lblBusiness.DataBindings.Add("Text", DT_BankPD, "Bank")
            End With
        ...
        If MsgBoxYes("Are you sure you want to Validate this migration data?") = MsgBoxResult.Yes Then
            ...
            For x As Integer = 0 To GridView1.RowCount - 1
                ...
                If GridView1.GetRowCellDisplayText(x, "Terms") > MaxTerms Then
                    ErrorX &= Num & String.Format(".) Product is only allowed up to {0} Term(s) Please check your Terms at row ", MaxTerms) & x + 1 & vbCrLf
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "Account Number") = "" Then
                    ...
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "Collateral") = "" And (GridView1.GetRowCellValue(x, "MortgageID") = 1 Or GridView1.GetRowCellValue(x, "MortgageID") = 2) Then
                ...
                If If(IsDate(GridView1.GetRowCellValue(x, "Date Availed")), CDate(GridView1.GetRowCellValue(x, "Date Availed")), Date.Now) > Date.Now Then
                    ...
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "FDD").ToString = "" Or IsDate(GridView1.GetRowCellValue(x, "FDD")) = False Then
                    ErrorX &= Num & ".) Please check your data under column FDD at row " & x + 1 & vbCrLf
                    Num += 1
                End If
                ...
                If IsNumeric(GridView1.GetRowCellValue(x, "Principal Balance")) And IsNumeric(GridView1.GetRowCellValue(x, "Principal")) Then
                    If CDbl(GridView1.GetRowCellValue(x, "Principal Balance")) > CDbl(GridView1.GetRowCellValue(x, "Principal")) Then
                        ErrorX &= Num & ".) Principal Balance is greater than Principal, Please check your data at row  " & x + 1 & vbCrLf
                        Num += 1
                    End If
                End If
                ...
                If IsNumeric(GridView1.GetRowCellValue(x, "UDI Balance")) And IsNumeric(GridView1.GetRowCellValue(x, "UDI")) Then
                    If CDbl(GridView1.GetRowCellValue(x, "UDI Balance")) > CDbl(GridView1.GetRowCellValue(x, "UDI")) Then
                        ErrorX &= Num & ".) UDI Balance is greater than UDI, Please check your data at row  " & x + 1 & vbCrLf
                        Num += 1
                    End If
                End If
                If GridView1.GetRowCellValue(x, "RPPD").ToString = "" Or IsNumeric(GridView1.GetRowCellValue(x, "RPPD")) = False Then
                ...
                If IsNumeric(GridView1.GetRowCellValue(x, "RPPD Balance")) And IsNumeric(GridView1.GetRowCellValue(x, "RPPD")) Then
                    If CDbl(GridView1.GetRowCellValue(x, "RPPD Balance")) > CDbl(GridView1.GetRowCellValue(x, "RPPD")) Then
                        ErrorX &= Num & ".) RPPD Balance is greater than RPPD, Please check your data at row  " & x + 1 & vbCrLf
                        Num += 1
                    End If
                End If
                ...
                If GridView1.GetRowCellDisplayText(x, "Bank").ToString = "" Then
                    ...
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "CV Number").ToString = "" Then
                    ErrorX &= Num & ".) Please check your data under column CV Number at row  " & x + 1 & vbCrLf
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "CV Number").ToString.Length > 50 Then
                    ErrorX &= Num & ".) Data too long for CV Number at row " & x + 1 & vbCrLf
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "PDL/SML Account").ToString.Length > 50 Then
                    ErrorX &= Num & ".) Data too long for PDL/SML Account at row " & x + 1 & vbCrLf
                    Num += 1
                End If
                If GridView1.GetRowCellValue(x, "PDL/SML Card").ToString.Length > 50 Then
                    ErrorX &= Num & ".) Data too long for PDL/SML Card at row " & x + 1 & vbCrLf
                    Num += 1
                End If
