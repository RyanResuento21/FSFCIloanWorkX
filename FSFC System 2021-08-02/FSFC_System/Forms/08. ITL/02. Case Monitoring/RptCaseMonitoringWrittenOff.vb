Public Class RptCaseMonitoringWrittenOff
    ...
    Private Sub Rpt_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        ReportLabelFontSettings({lblTitle, lblAsOf, lblBranch, lblAA1, lblAP1, lblAA2, lblAP2, lblAA1T, lblAP1T, lblAA2T, lblAP2T})
