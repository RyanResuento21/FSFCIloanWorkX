...
Public Class FrmCollectionDueReport
    ...
    Private Sub FrmCollectionDueReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DT_Result = DataSource("SELECT '' AS 'Credit Number', '' AS 'Borrower', '' AS 'Date Granted', '' AS 'Date Maturity', '' AS 'Term/Interest', 0.0 AS 'Principal', 0.0 AS 'Outstanding Balance', 0.0 AS 'Interest', 0.0 AS 'Interest Balance', 0.0 AS 'Principal Due', '' AS 'Principal Paid', 0.0 AS 'Interest Due', '' AS 'Interest Paid', '' AS 'Total Paid Amount' LIMIT 0")
        DT_Print = DataSource("SELECT '' AS 'Marketing', '' AS 'Borrower', '' AS 'Date Granted', '' AS 'Date Maturity', '' AS 'Term/Interest', 0.0 AS 'Principal', 0.0 AS 'Outstanding Balance', 0.0 AS 'Interest', 0.0 AS 'Interest Balance', 0.0 AS 'Principal Due', '' AS 'Principal Paid', 0.0 AS 'Interest Due', '' AS 'Interest Paid', '' AS 'Total Paid Amount' LIMIT 0")
    ...
    Private Sub FixUI(ApplyUI As Boolean)
        ...
        Catch ex As Exception
            TriggerBugReport("Collection Due Report - FixUI", ex.Message.ToString)
        End Try
    End Sub
    ...
    Private Sub LblTitle_Click(sender As Object, e As EventArgs) Handles lblTitle.Click
        OpenFormHistory("Collection Due Report", lblTitle.Text)
    End Sub
    ...
    Public Sub LoadData()
        ...
        If cbxAllAO.Checked Then
            For x As Integer = 0 To DT_AO.Rows.Count - 1
                ...
                SQL &= "  Interest,"
                SQL &= "  IF(0 = 0,'',0)  AS 'Principal Paid',"
                SQL &= "  IF(0 = 0,'',0) AS 'Interest Paid',"
                SQL &= "  IF(0 = 0,'',0) AS 'Total Amount Paid', Face_Amount, TermType"
                ...
                If DT_Temp.Rows.Count > 0 Then
                    ...
                    Dim PrincipalDue As Double
                    Dim PrincipalPaid As Double
                    Dim InterestDue As Double
                    ...
                    For y As Integer = 0 To DT_Temp.Rows.Count - 1
                        ...
                        With DT_Result.Rows
                            .Add(DT_Temp(y)("Credit Number"), DT_Temp(y)("Borrower"), DT_Temp(y)("Date Granted"), DT_Temp(y)("Date Maturity"), DT_Temp(y)("Term/Interest"), CDec(DT_Temp(y)("Principal")), CDec(Balances(0)), CDec(DT_Temp(y)("Interest")), CDec(Balances(1)), CDec(Dues(0)), If(DT_Temp(y)("Principal Paid").ToString = "", "", CDec(DT_Temp(y)("Principal Paid"))), CDec(Dues(1)), If(DT_Temp(y)("Interest Paid").ToString = "", "", CDec(DT_Temp(y)("Interest Paid"))), If(DT_Temp(y)("Total Amount Paid").ToString = "", "", CDec(DT_Temp(y)("Total Amount Paid"))))
                        End With
                        With DT_Print.Rows
                        ...
                        PrincipalDue += CDec(Dues(0))
                        PrincipalPaid += If(DT_Temp(y)("Principal Paid").ToString = "", 0, CDec(DT_Temp(y)("Principal Paid")))
                        InterestDue += CDec(Dues(1))
                        InterestPaid += If(DT_Temp(y)("Interest Paid").ToString = "", 0, CDec(DT_Temp(y)("Interest Paid")))
                        TotalPaid += If(DT_Temp(y)("Total Amount Paid").ToString = "", 0, CDec(DT_Temp(y)("Total Amount Paid")))
                    Next
                    DT_Result.Rows.Add("", "Total " & DT_Temp.Rows.Count, "", "", "", Principal, Balance, Interest, InterestBalance, PrincipalDue, FormatNumber(PrincipalPaid, 2), InterestDue, FormatNumber(InterestPaid, 2), FormatNumber(TotalPaid, 2))
                End If
            Next
        Else
                ...
                If cbxAccountOfficer.Properties.Items.Item(x).CheckState = CheckState.Checked Then
                    ...
                    If DT_Temp.Rows.Count > 0 Then
                        ...
                        For y As Integer = 0 To DT_Temp.Rows.Count - 1
                            ...
                            TotalPaid += If(DT_Temp(y)("Total Amount Paid").ToString = "", 0, CDec(DT_Temp(y)("Total Amount Paid")))
                        Next
                        DT_Result.Rows.Add("", "Total " & DT_Temp.Rows.Count, "", "", "", Principal, Balance, Interest, InterestBalance, PrincipalDue, PrincipalPaid, InterestDue, InterestPaid, TotalPaid)
                    End If
                End If
            Next
        End If
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        Cursor = Cursors.WaitCursor
        Dim Report As New RptCollectionDueReport
        With Report
            ...
            .Name = String.Format("Collection Due Report of {0} {1}", If(cbxAllB.Checked, "All Branches", cbxBranch.Text), DateFilter)
            ...
            .lblTermInterest.DataBindings.Add("Text", DT_Print, "Term/Interest")
            ...
            .lblPrincipalDue.DataBindings.Add("Text", DT_Print, "Principal Due")
            .lblPrincipalPaid.DataBindings.Add("Text", DT_Print, "Principal Paid")
            .lblInterestDue.DataBindings.Add("Text", DT_Print, "Interest Due")
            .lblInterestPaid.DataBindings.Add("Text", DT_Print, "Interest Paid")
            .lblTotalPaid.DataBindings.Add("Text", DT_Print, "Total Amount Paid")
            ...
            .lblPrincipalDueF.DataBindings.Add("Text", DT_Print, "Principal Due")
            .lblPrincipalPaidF.DataBindings.Add("Text", DT_Print, "Principal Paid")
            .lblInterestDueF.DataBindings.Add("Text", DT_Print, "Interest Due")
            .lblInterestPaidF.DataBindings.Add("Text", DT_Print, "Interest Paid")
            .lblTotalPaidF.DataBindings.Add("Text", DT_Print, "Total Amount Paid")
            Logs("Collection Due Report", "Print", "[SENSITIVE] Print Collection Due Report", "", "", "", "")
