...
Public Class FrmAgingPastDue

    Public vPrint As Boolean
    Dim FirstLoad As Boolean

    Private Sub FrmAgingPastDue_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FixUI(ApplyUI As Boolean)
        ...
        Catch ex As Exception
            TriggerBugReport("Aging Past Due - FixUI", ex.Message.ToString)
        End Try
    End Sub
    ...
    Private Sub LblTitle_Click(sender As Object, e As EventArgs) Handles lblTitle.Click
        OpenFormHistory("Aging Past Due", lblTitle.Text)
    End Sub
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        With Report
            ...
            .Name = String.Format("AGING OF PAST DUE REPORT of {0} {1}", If(cbxAllB.Checked, "All Branches", cbxBranch.Text), DateFilter)
            ...
            Logs("Aging Past Due", "Print", "[SENSITIVE] Print Aging Past Due", "", "", "", "")
    ...
    Private Sub IDetails_Click(sender As Object, e As EventArgs) Handles iDetails.Click
        ...
        With Details
            ...
            .lblTitle.Text = "AGING PAST DUE OF " & BandedGridView1.GetFocusedRowCellValue("Account Officer").ToString
            .vPrint = vPrint
            .ShowDialog()
            .Dispose()
        End With
