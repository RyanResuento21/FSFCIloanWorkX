Public Class RptGeneralLedgerAccountDetails
    ...
    Private Sub Rpt_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        If AllowStandardUI = False Then
            Exit Sub
        End If
        ReportLabelWithBackgroundFontSettings({XrLabel10, XrLabel1, XrLabel2, XrLabel3, XrLabel4, XrLabel5})
        ReportLabelFontSettings({lblTitle, lblAsOf, lblDocument, lblPosting, lblDepartment, lblDebit, lblCredit, lblRemarks})
