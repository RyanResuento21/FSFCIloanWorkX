Public Class RptGeneralLedgerDetailed
    ...
    Private Sub Rpt_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        If AllowStandardUI = False Then
            Exit Sub
        End If
        ReportLabelWithBackgroundFontSettings({XrLabel10, XrLabel5, XrLabel6, XrLabel8, XrLabel7, XrLabel9, XrLabel2, XrLabel3, XrLabel4})
        ReportLabelFontSettings({lblTitle, XrLabel1, lblAsOf, lblSource, lblMotherCode, lblMother, lblAccountCode, lblSubAccount, lblDepartment, lblDebit, lblCredit, lblTotal})
