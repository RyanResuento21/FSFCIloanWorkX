Public Class RptGeneralJournalV2
    ...
    Private Sub Rpt_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        If AllowStandardUI = False Then
            Exit Sub
        End If
        ReportLabelWithBackgroundFontSettings({XrLabel5, XrLabel6, XrLabel8, XrLabel15, XrLabel11, XrLabel13, XrLabel14, XrLabel31})
        ReportLabelFontSettings({lblTitle, lblAsOf, lblPostingDate, lblPayor, lblDocumentNumber, lblExplanation, lblAccountCode, lblDebit, lblCredit, lblDebitT, lblCreditT})
