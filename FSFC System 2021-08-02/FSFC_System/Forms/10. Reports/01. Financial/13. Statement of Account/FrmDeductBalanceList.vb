Public Class FrmDeductBalanceList

    Private Sub FrmDeductBalanceList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FixUI(ApplyUI As Boolean)
        ...
        Catch ex As Exception
            TriggerBugReport("Deduct Balance List - FixUI", ex.Message.ToString)
        End Try
    End Sub
    ...
    Private Sub LoadData()
        ...
        SQL &= " FROM credit_deductbalance "
        SQL &= String.Format(" WHERE `status` = 'ACTIVE' AND BranchID = '{0}' AND deduct_status = 'PENDING' ORDER BY DATE(AsOf) DESC ;", Branch_ID)
