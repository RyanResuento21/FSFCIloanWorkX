...
Public Class DSCamCapture
    ...
    Public WithEvents TmrSaved As New Timer With {.Interval = 10}
    Public Event FrameCaptured(capImage As Bitmap)
    Public Event FrameSaved(capImage As Bitmap, imgPath As String)
    ...
    Public SaveImage As Boolean = False
...
#End If
    ...
    Public Function ConnectToDevice(deviceIndex As Integer, frameRate As Integer, windowSize As Size, frameSize As FrameSizes, hParent As IntPtr) As Boolean
    ...
    ' <remarks></remarks>
    Public Sub ResizeWindow(xLoc As Integer, yLoc As Integer, sWidth As Integer, sHeight As Integer)
    ...
    Public Sub SaveCurrentFrame(strFileName As String)
    ...
    Private Sub Tmr2_Tick(sender As Object, e As EventArgs) Handles TmrSaved.Tick
    ...
    Private Sub Tmr_Tick(sender As Object, e As EventArgs) Handles TmrCaptured.Tick
    ...
    Private Sub SetupGraph(dev As DsDevice, iFrameRate As Integer, winSize As Size, imgSize As Size)
        Dim hr As Integer
...
#End If
        ...
        Try
            ...
            SetConfigParms(iFrameRate, imgSize.Width, imgSize.Height)
    ...
    Private Sub SaveSizeInfo(sampGrabber As ISampleGrabber)
        ...
        Dim vInfoHeader As New VideoInfoHeader()
    ...
    Private Sub ConfigureSampleGrabber(sampGrabber As ISampleGrabber)
        Dim hr As Integer
        Dim media As New AMMediaType With {
    ...
    Private Sub SetConfigParms(iFrameRate As Integer, iWidth As Integer, iHeight As Integer)
        Dim hr As Integer
        Dim obj As Object = Nothing
        Dim media As AMMediaType = Nothing
        Dim videoStreamConfig As IAMStreamConfig
        'im videoControl As IAMVideoControl = DirectCast(capFilter, IAMVideoControl)
...
#End If
    ...
    Private Function SampleCB(SampleTime As Double, pSample As IMediaSample) As Integer Implements ISampleGrabberCB.SampleCB
        ...
        If pSample.GetPointer(buffPtr) = 0 And dataLen > 0 Then
            ...
            If SaveImage Or getImage Then
                ...
                Dim bounds As New Rectangle(0, 0, m_videoWidth, m_videoHeight)
